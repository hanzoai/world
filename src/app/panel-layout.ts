...
export class PanelLayoutManager implements AppModule {
  ...
  async init(): Promise<void> {
    ...
    // GitHub stars count hidden — monochromatic chrome.
  ...
  private getGateAction(reason: PanelGateReason): () => void {
    switch (reason) {
      ...
      case PanelGateReason.FREE_TIER:
        return () => window.open('https://world.hanzo.ai/pro', '_blank');
      default:
        return () => {};
    }
  }
  ...
  private async fetchGitHubStars(): Promise<void> {
    try {
      const response = await fetch('https://api.github.com/repos/hanzoai/world');
  ...
  renderLayout(): void {
    setTrustedHtml(this.ctx.container, trustedHtml(`
      ...
      <div class="header">
        ...
        // Single-domain canonical URLs: world.hanzo.ai serves all variants
        // under path prefixes (`/`, `/tech`, `/finance`, ...). SITE_VARIANT
        // is resolved from path at boot — see src/config/variant.ts.
        const vHref = (v: string) => {
          if (local || SITE_VARIANT === v) return '#';
          return v === 'full' ? 'https://world.hanzo.ai/' : `https://world.hanzo.ai/${v}`;
        };
        ...
        return `
          ...
          <a href="https://hanzo.ai" target="_blank" rel="noopener" class="hanzo-brand" title="Hanzo">
            <svg class="hanzo-mark" width="18" height="18" viewBox="0 0 24 24" aria-hidden="true">
              <rect x="1" y="1" width="22" height="22" rx="4" fill="currentColor"/>
              <path d="M7 6h2.2v5h5.6V6H17v12h-2.2v-5H9.2v5H7z" fill="var(--bg, #000)"/>
            </svg>
            <span class="hanzo-wordmark">Hanzo</span>
          </a>
          <span class="logo">World</span><span class="logo-mobile">Hanzo World</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
          <a href="https://x.com/hanzoai" target="_blank" rel="noopener" class="credit-link">
            <svg class="x-logo" width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            <span class="credit-text">@hanzoai</span>
          </a>
          <a href="https://github.com/hanzoai/world" target="_blank" rel="noopener" class="github-link" title="${t('header.viewOnGitHub')}">
      ...
      <nav class="mobile-menu" id="mobileMenu">
        <div class="mobile-menu-header">
          <span class="mobile-menu-title">HANZO WORLD</span>
        ...
        <a class="mobile-menu-item" href="https://x.com/hanzoai" target="_blank" rel="noopener">
          ...
          <span class="mobile-menu-item-label">@hanzoai</span>
        </a>
        <div class="mobile-menu-divider"></div>
        <div class="mobile-menu-footer-links">
          <a href="${this.ctx.isDesktopApp ? 'https://world.hanzo.ai/pro' : 'https://world.hanzo.ai/pro'}" target="_blank" rel="noopener">Pro</a>
          <a href="${this.ctx.isDesktopApp ? 'https://world.hanzo.ai/blog/' : 'https://world.hanzo.ai/blog/'}" target="_blank" rel="noopener">Blog</a>
          <a href="${this.ctx.isDesktopApp ? 'https://world.hanzo.ai/docs' : 'https://world.hanzo.ai/docs'}" target="_blank" rel="noopener">Docs</a>
          <a href="https://status.world.hanzo.ai/" target="_blank" rel="noopener">Status</a>
        </div>
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          ...
          <div class="site-footer-brand-text">
            <span class="site-footer-name">HANZO WORLD</span>
            <span class="site-footer-sub">v${__APP_VERSION__} &middot; <a href="https://x.com/hanzoai" target="_blank" rel="noopener" class="site-footer-credit">@hanzoai</a></span>
          </div>
        </div>
        <nav>
          <a href="${this.ctx.isDesktopApp ? 'https://world.hanzo.ai/pro' : 'https://world.hanzo.ai/pro'}" target="_blank" rel="noopener">Pro</a>
          ...
          <a href="${this.ctx.isDesktopApp ? 'https://world.hanzo.ai/docs' : 'https://world.hanzo.ai/docs'}" target="_blank" rel="noopener">Docs</a>
          <a href="https://status.world.hanzo.ai/" target="_blank" rel="noopener">Status</a>
          <a href="https://github.com/hanzoai/world" target="_blank" rel="noopener">GitHub</a>
          <a href="https://discord.gg/re63kWKxaz" target="_blank" rel="noopener">Discord</a>
          <a href="https://x.com/hanzoai" target="_blank" rel="noopener">X</a>
          ${this.ctx.isDesktopApp ? '' : `<span id="footerDownloadMount"></span>`}
        </nav>
        <span class="site-footer-copy">&copy; ${new Date().getFullYear()} Hanzo AI</span>
      </footer>
