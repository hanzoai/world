...
Sentry.init({
  ...
  environment: (location.hostname === 'world.hanzo.ai' || location.hostname.endsWith('.world.hanzo.ai')) ? 'production'
...
// In web production, route RPC calls through api.world.hanzo.ai (Cloudflare edge).
