...
**Base URL**: All endpoints are relative to `/api/` (e.g., `https://world.hanzo.ai/api/earthquakes`).
...
| # | Pattern | Matches |
|---|---------|---------|
| 1 | `worldmonitor\.app$` | `https://world.hanzo.ai` |
| 2 | `\.worldmonitor\.app$` | `https://*.world.hanzo.ai` |
